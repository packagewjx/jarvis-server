...
export JARVIS_CHAT_RETENTION_DAYS="${JARVIS_CHAT_RETENTION_DAYS:-7}"
export JARVIS_JWT_SECRET="${JARVIS_JWT_SECRET:-dev-jwt-secret-change-me}"
export JARVIS_JWT_ISSUER="${JARVIS_JWT_ISSUER:-jarvis-server}"
export JARVIS_JWT_ACCESS_TTL_SEC="${JARVIS_JWT_ACCESS_TTL_SEC:-7200}"
export JARVIS_JWT_REFRESH_TTL_SEC="${JARVIS_JWT_REFRESH_TTL_SEC:-2592000}"
export JARVIS_DB_JDBC_URL="${JARVIS_DB_JDBC_URL:-jdbc:postgresql://jarvis-postgres:5432/jarvis}"
export JARVIS_DB_USER="${JARVIS_DB_USER:-jarvis}"
export JARVIS_DB_PASSWORD="${JARVIS_DB_PASSWORD:-jarvis}"
export JARVIS_DB_MAX_POOL_SIZE="${JARVIS_DB_MAX_POOL_SIZE:-10}"
